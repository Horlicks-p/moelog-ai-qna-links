...
class Moelog_AIQnA_Pregenerate
{
     ...
     */
    private function schedule_single_task($post_id, $question, $delay = 0)
    {
        $timestamp = time() + $delay;

        // 檢查是否已排程
        $args = [$post_id, $question];
        $scheduled = wp_next_scheduled("moelog_aiqna_pregenerate", $args);
        ...
        // 排程新任務
        wp_schedule_single_event($timestamp, "moelog_aiqna_pregenerate", $args);
    }
